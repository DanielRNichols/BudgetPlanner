...
{
    public class RegisterSplitEntryRepository : DbResourceRepository<RegisterSplitEntry>, IRegisterSplitEntryRepository
    {
        ...
        public override async Task<IList<RegisterSplitEntry>> Get(bool includeRelated = false)
        {
            if(includeRelated)
            {
